...
## Общие сведения
В этой задаче мы продолжим работу над блогом [*blog-1-anonymous-blog-challenge*][blog-1-challenge] (задача создания анонимного блога). Но теперь мы ограничим действия пользователей на нашем сайте, в зависимости от того, являются ли они зарегистрированными пользователями и, если да, то чем они могут пользоваться.
